...
export const DAILY_BLOCKS = [
  ...
  },
  {
    id: "mindfulness",
    title: "Mindfulness",
    description: "Breathing exercise or founder stress check-in",
    estimatedMinutes: 3,
    icon: "wind",
    href: "/mindfulness",
    mandatory: false,
...
export const NAV_ITEMS = [
  ...
  { label: "Mindful", href: "/mindfulness", icon: "wind" },
...
export const DIFFICULTY_UP_THRESHOLD = 0.75;
export const DIFFICULTY_DOWN_THRESHOLD = 0.3;
export const ROLLING_WINDOW_DAYS = 7;
export const MIN_SESSIONS_FOR_ADJUSTMENT = 7;
